...
INTEGER(4)									:: Lda, Ldfac
COMPLEX(8), DIMENSION (N, N)				:: aa
INTEGER(4), DIMENSION (N)					:: ipvt
...
!--------------------------------------
	...
	FJAC(1,1) = (f1(kapa1, x(2), N)-f1(kapa2, x(2), N))/h(1)
	FJAC(1,2) = (f1(x(1), gama1, N)-f1(x(1), gama2, N))/h(2)
	FJAC(2,1) = (f2(kapa1, x(2), N)-f2(kapa2, x(2), N))/h(1)
	FJAC(2,2) = (f2(x(1), gama1, N)-f2(x(1), gama2, N))/h(2)

!	print*, fjac(1,1)
!	print*, fjac(1,2)
!	print*, fjac(2,1)
!	print*, fjac(2,2)
!	print*, fjac(1,1)*fjac(2,2) - fjac(1,2)*fjac(2,1)
!	print*,''
