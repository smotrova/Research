...
REAL(8), PARAMETER		:: e_newt = 1.0D-8						!Accuracy of Newton method
...
REAL(8), PARAMETER, DIMENSION(1:nn) :: h=(/1.D-5, 1.D-8/)		! Shag po peremennoi kapa, gama dla	chislennogo nahojdeniya pervih proizvodnih po kapa, gama sootvetstvenno
